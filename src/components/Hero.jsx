...
function Hero() {
  return (
    <div
      id='hero'
      className='w-screen h-screen flex items-center dark:bg-gray-950'
    >
      <div className='mx-auto w-1/2  max-w-xl'>
        ...
        <Button addedClasses='text-3xl w-2/5 py-2 px-3 mr-10'>Login</Button>
        <Button addedClasses='text-3xl w-2/5 py-2 px-3 mr-10'>Sign-Up</Button>
      </div>
      <div className='w-1/2 text-left pl-10 max-w-3xl h-screen mr-0'>
        <img
          className='rounded-3xl float-left h-5/6'
